  ...
  return (
    <div className="shadow-md w-[80vw] h-[100vh] flex-col">
      <div id="title" className="w-full  mb-2 border-b p-3">
        <h1 className="text-lg mt-1">{email.subject ? email.subject: <p className="text-gray-500">No subject</p>}</h1>
        <p className="text-sm text-gray-500"><span className="text-gray-500">From:</span> {email.from_email}</p>
      </div>
